...
![placeholder: a messy desk / terminal screenshot showing the "which number was that again" chaos](./images/vouch-chaos-placeholder.png)
...
![placeholder: screenshot of `vouch explore` in the browser](./images/vouch-explore-placeholder.png)
...
![placeholder: PDF snippet showing a cited number linking to its provenance appendix](./images/vouch-provenance-placeholder.png)
