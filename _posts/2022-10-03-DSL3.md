...
The basic idea with this parser is that we are combining[^4] many simple parsers into a more complex parser that captures the grammar/rules of our domain specific language. Here is the finished parser:
